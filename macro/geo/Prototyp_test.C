...
//     BOX_Air->AddNode(vPlate_B10_front,1,new TGeoTranslation(0,0, -0.5*(plate.dy+Calor_Size) ));
    ...
    Detector->AddNode(vPlate_B10, 2, new TGeoTranslation(0,0.5*(calor.dy+plate.dy),-0.5*plate.dz));
    Detector->AddNode(vPlate_B10, 3, new TGeoTranslation(0,-0.5*(calor.dy+plate.dy),0.5*plate.dz));
    Detector->AddNode(vPlate_B10, 4, new TGeoTranslation(0,-0.5*(calor.dy+plate.dy),-0.5*plate.dz));
    
    Detector->AddNode(vPlate_B10_Roter, 1,new TGeoTranslation(0.5*(calor.dy+plate.dy),0,0.5*plate.dz));
    Detector->AddNode(vPlate_B10_Roter, 2,new TGeoTranslation(0.5*(calor.dy+plate.dy),0,-0.5*plate.dz));
    Detector->AddNode(vPlate_B10_Roter, 3,new TGeoTranslation(-0.5*(calor.dy+plate.dy),0,0.5*plate.dz));
    Detector->AddNode(vPlate_B10_Roter, 4,new TGeoTranslation(-0.5*(calor.dy+plate.dy),0,-0.5*plate.dz));
