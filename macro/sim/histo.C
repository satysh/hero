void histo(TString inputDir = "output")
{
    ...
    for (UInt_t i = 0; i < nEvents; i++)
    {
        ...
        cout << "INFO: TrackID: " << minLiveNutr[3] << ", neutron with min life time: " << minLiveNutr[0]*1e-3 << ", timeIn: " << minLiveNutr[1] << ", timeOut: " << minLiveNutr[2] << " (msec)" << endl;
        cout << "INFO: TrackID: " << maxLiveNutr[3] << ", neutron with max life time: " << maxLiveNutr[0]*1e-3 << ", timeIn: " << maxLiveNutr[1] << ", timeOut: " << maxLiveNutr[2] << " (msec)" << endl;
        cout << "///////////////////////////////////" << endl;
    }
